...
/**
 * Interface for processor (the basic processing unit of DEVS) instances.
 * @author Gabriel Dimitriu
 *
 */
public interface IProcessor extends IBaseInstantiableType, IConnectableInstance, IRunningInstance{
