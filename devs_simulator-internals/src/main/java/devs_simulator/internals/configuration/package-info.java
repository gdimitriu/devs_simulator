 ...
 */
/**
 * Loader and definition implementations for the configuration of DEVS structure.
 * Here are the loader and definitions which transform the xml description into real internal structure.
